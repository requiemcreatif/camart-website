      ...
      <div className="mx-auto w-full max-w-[1280px] px-6 md:px-10">
        <div className="grid gap-12 md:grid-cols-[2.2fr_1fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-4 max-w-xl text-[15px] leading-relaxed text-[#777777] md:text-[18px]">
            ...
            <div className="mt-6 flex items-center gap-4 text-[#777777]">
              <a href="#" aria-label="Instagram" className="hover:text-[#F2F2F2]">
          ...
          <div>
            ...
            <ul className="space-y-3 text-[15px] text-[#7A7A7A] md:text-[18px]">
              {navLinks.map((item) => (
                <li key={item.label}>
          ...
          <div>
            ...
            <div className="space-y-3 text-[15px] text-[#7A7A7A] md:text-[18px]">
              <p>info@camart.es</p>
              <p>+34 600 000 000</p>
            </div>
          </div>
        ...
        <div className="mt-8 flex flex-col justify-between gap-4 text-[13px] text-[#5F5F5F] md:flex-row md:text-[15px]">
