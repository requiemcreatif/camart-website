        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_1.6fr]">
          <div className="space-y-8">
            <div>
              ...
              <h2 className="max-w-md text-5xl font-extrabold leading-tight tracking-[-0.02em] text-[#F2F2F2] md:text-6xl">
                Hablemos de tu Próximo Evento
              </h2>
            </div>

            <p className="max-w-md text-[18px] leading-relaxed text-[#8C8C8C]">
          ...
          <form className="space-y-5" onSubmit={onSubmit}>
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  required
                  className="h-12 w-full rounded-none border border-[#2F2F2F] bg-[#121212] px-4 text-base text-[#F2F2F2] outline-none placeholder:text-[#6D6D6D] focus:border-[#5B5B5B]"
                />
              </div>
              <div>
                <label className="mb-2 block text-[15px] text-[#F2F2F2]">
            ...
            <div>
              <label className="mb-2 block text-[15px] text-[#F2F2F2]">Email</label>
              <input
                name="email"
                type="email"
            ...
            <div>
              ...
              <textarea
                ...
                required
                className="min-h-[170px] w-full rounded-none border border-[#2F2F2F] bg-[#121212] px-4 py-3 text-base text-[#F2F2F2] outline-none placeholder:text-[#6D6D6D] focus:border-[#5B5B5B]"
              />
            </div>
            ...
            <label className="flex items-center gap-3 text-[15px] text-[#8C8C8C]">
              <input
                type="checkbox"
                name="newsletter"
                className="h-4 w-4 rounded-none border border-[#333333] bg-transparent"
              />
