...
export function ArtistsSection() {
  ...
  return (
    <section id="artists" className="scroll-mt-[84px] bg-[#0A0A0A] py-20">
          ...
          {visibleArtists.map((artist) => (
            <article key={artist.id} className="overflow-hidden bg-[#1A1A1A]">
              ...
              <div className="px-5 py-5">
                ...
                <Button
                  asChild
                  className="mt-2 h-8 rounded-none bg-[#F2F2F2] px-3 text-xs font-semibold text-[#0A0A0A] hover:bg-[#FFFFFF]"
                >
